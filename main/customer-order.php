...
if (isset($_POST["order"])) {
    ...
    if (tambah($_POST) > 0) {
        echo " <script> alert('Pesanan berhasil dilakukan!');
        document.location.href = 'customer-index.php'
        </script>
        ";
    } else {
        echo "<script> 
        alert('Pesanan gagal dilakukan!');
        document.location.href = 'customer-index.php'
        </script>
        ";
    }
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <ul>
            ...
            <li>
                ...
                <input type="text" name="email_customer" id="email_customer" required>
            </li>
            <li>
            ...
            <li>
                <label for="total_pesanan">Pesanan</label>
                <input type="text" name="total_pesanan" id="total_pesanan" required>
            </li>
            <li>
            ...
            <li>
                <label for="tanggal_pesanan">Tanggal Pesan</label>
                <input type="text" name="tanggal_pesanan" id="tanggal_pesanan" required>
            </li>
            <li>
            ...
            <li>
                <button class="btn" type ="submit" name="order">Tambah!</button>
            </li>
        </ul>
    </form>
    </div>
