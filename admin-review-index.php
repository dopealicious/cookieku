...
$idreview = query("SELECT * FROM review");


// tombol cari ditekan
if (isset($_POST["cari"])) {
    $idreview = cari($_POST["keyword"]);
}
...
<head>
    ...
    <title>Halaman Data Review</title>
    <link
      rel="stylesheet"
...
<body>
    ...
    <h1>Daftar Data <span>Review</span></h1>
    <div class="container">
        <aside>
          <ul class="menu">
    ...
    <table border="1" cellpadding="10" cellspacing="10">
        ...
        <tr>
            ...
            <td> <?= $row["rating"]; ?></td>
            <td> <?= $row["pesan_review"]; ?></td>
            <td>
                <a href="admin-review-ubah.php?id_review=<?= $row["id-review"]; ?>"><i class="fas fa-edit"></i></a>
                <a href="admin-review-hapus.php?id_review=<?= $row["id_review"]; ?>" onclick="return confirm('Yakin menghapus data?');"><i class="fas fa-trash-alt"></a>
            </td>
        </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
